  ...
  render() {
    return (
      <div className="App">
        ...
        <ToDoList toDos={ this.props.toDos } filter={ this.state.filter } delete={ this.deleteTask} setCompleted={this.setCompleted}/>
      </div>
    );
  }
}
...
const connection = connect(); // accedes a las funciones del parametro en reducers
const connectedApp = connection(App); // app dentro de redux

export default connect(mapStateToProps)(App); // devuelve el state
